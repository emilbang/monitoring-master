...
And you will need to do this manually. To read more about setting up github auth see: [Chronograf docs](https://docs.influxdata.com/chronograf/v1.7/administration/managing-security/#configuring-github-authentication).
